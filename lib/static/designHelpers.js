...
(function (global, _inputs) {
  ...
  const generalProps = this.generalProps || require('generalProps.js')
  ...
  function renderDesignComponent (
    ...
    let designComponentContent

    if (
      renderingResult.props[generalProps.generalPropName] != null &&
      (
        renderingResult.props[generalProps.generalPropName].block === true ||
        renderingResult.props[generalProps.generalPropName].block === 'true'
      )
    ) {
      designComponentContent = '<div class="designComponent designComponentBlock">'
    } else {
      designComponentContent = '<div class="designComponent">'
    }
